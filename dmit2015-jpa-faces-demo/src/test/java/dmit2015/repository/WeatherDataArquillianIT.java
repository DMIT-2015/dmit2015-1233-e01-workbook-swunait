...
//        var firstWeatherData = weatherDataList.get(0);
        // TODO Assert that each property match expected results for the first record
        //assertThat(firstWeatherData.getProperty1()).isEqualTo(expectedFirstRecordProperty1);
        //assertThat(firstWeatherData.getProperty2()).isEqualTo(expectedFirstRecordProperty2);

        // Get the last entity and compare with expected results
//        var lastWeatherData = weatherDataList.get(weatherDataList.size() - 1);
        // TODO Assert that each property match expected results for the last record
        //assertThat(lastWeatherData.getProperty1()).isEqualTo(expectedLastRecordProperty1);
        //assertThat(lastWeatherData.getProperty2()).isEqualTo(expectedLastRecordProperty2);
    ...
    void add_ValidData_Added(String property1, String property2, String property3) throws SystemException, NotSupportedException {
        // Arrange
        ...
        try {
            ...
            // Optional<WeatherData> optionalWeatherData = _weatherDataRepository.findById(newWeatherData.getPrimaryKeyProperty());
            // assertThat(optionalWeatherData.isPresent())
            //     .isTrue();
